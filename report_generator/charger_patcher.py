...
Usage:
    from report_generator.charger_patcher import ChargerPatcher
...
from report_generator.segment_algorithms import VEHICLE_CONFIG
from report_generator.xlsx_patch_common import (
    _cell_is_empty,
...
def main(argv: list | None = None) -> int:
    ...
    ``python -m report_generator.charger_patcher <target> [--persist-raw]``
    ...
    parser = argparse.ArgumentParser(
        prog="python -m report_generator.charger_patcher",
