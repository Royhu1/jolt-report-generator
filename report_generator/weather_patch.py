...
Usage (Python)
--------------
    from report_generator.weather_patch import patch_weather
...
-----------
    # default coarse
    python -m report_generator.weather_patch \
...
from report_generator.weather_patcher import WeatherPatcher
