...
#
# New code should import from ``report_generator.segmentation``
...
# ── constants ────────────────────────────────────────────────────────────────
from report_generator.segmentation.constants import (  # noqa: F401
    _ANCHOR_PRIVATE_KEYS,
    AC_COL,
    DC_COL,
    MASS_COL,
...
from report_generator.segmentation.detection import (  # noqa: F401
    run_segment_detection,
)

# ── mass aggregation ─────────────────────────────────────────────────────────
from report_generator.segmentation.mass_aggregation import (  # noqa: F401
    _MAD_K,
    _MASS_AGG_METHODS,
    _TRIM_FRAC,
    _agg_mass,
...
from report_generator.segmentation.mass_clustering import (  # noqa: F401
...
# ── SOC-based detection ──────────────────────────────────────────────────────
from report_generator.segmentation.soc_detection import (  # noqa: F401
    find_charge_segments_by_soc,
    find_discharge_segments_by_soc,
)

# ── speed-based detection ────────────────────────────────────────────────────
from report_generator.segmentation.speed_detection import (  # noqa: F401
...
# ── timeutil ─────────────────────────────────────────────────────────────────
from report_generator.segmentation.timeutil import (  # noqa: F401
    _to_utc,
)
